...
public class CreateService1Activity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_create_service1);
        initView();
    }
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.iv_back:
                ...
                break;
            case R.id.tv_create:
                startActivity(new Intent(this, CreateService2Activity.class));
                break;
        }
    }
}
